...
The diffuse color is stored per object, and I added a dropdown to select which shader to display.  

I did the vertex displacement as a sine wave which wobbles the vertices.
